...
#ifndef TRITON_RELATIONSHIPS_H
#define TRITON_RELATIONSHIPS_H
...
public:
  explicit Relationships(Graph &graph) : graph(graph), getRelationshipsHandler(*this), getRelationshipsOfTypeHandler(*this),
