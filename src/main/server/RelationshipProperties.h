...
#ifndef TRITON_RELATIONSHIPPROPERTIES_H
#define TRITON_RELATIONSHIPPROPERTIES_H
...
public:
  explicit RelationshipProperties(Graph &graph) : graph(graph), getRelationshipPropertyByIdHandler(*this), 
...
#endif//TRITON_RELATIONSHIPPROPERTIES_H
