...
#ifndef TRITON_NODEPROPERTIES_H
#define TRITON_NODEPROPERTIES_H
...
public:
  explicit NodeProperties(Graph &graph) : graph(graph), getNodePropertyHandler(*this), getNodePropertyByIdHandler(*this),
